export default async function HomePage() {
  return (
    ...
    <h2 className="text-center text-5xl text-yellow-400 mb-8 mt-12">
        用科学的视角看政治
      </h2>
      <div className="flex gap-6 items-center justify-center my-8 mb-8">
        ...
        className="font-bold border-2 border-yellow-600 px-4 py-1 rounded-full hover:bg-yellow-600 hover:text-white transition-colors duration-300"
        >
          文 章
        </a>
        <a
    ...
    <article className="container mx-auto px-4 py-6 max-w-xl">
        <p className="my-4">
          你是否曾好奇，为什么有些国家和平稳定，而有些国家却总是陷入冲突？或者为什么有些政府运作良好，而另一些效率低下？在这里，我们用科学的视角来探索政治问题。这里没有偏见或立场，我们专注于理解政治运作背后的真实规律。
        </p>

        <h2 className="text-2xl font-semibold mt-6 mb-4">政治科学？</h2>
    ...
    <article className="container mx-auto px-4 py-6 max-w-xl">
        <h2 className="text-2xl font-semibold mt-6 mb-4">在这里能看到什么？</h2>
    ...
    <article className="container mx-auto px-4 py-6 max-w-xl">
        <h2 className="text-2xl font-semibold mt-6 mb-4">为什么这很重要？</h2>
    ...
    <article className="container mx-auto px-4 py-6 max-w-xl">
        <h2 className="text-2xl font-semibold mt-6 mb-4">一起探索吧！</h2>
