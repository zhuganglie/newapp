...
export default function SideBar() {
  ...
  return (
    <div>
      ...
      <aside
        className={`bg-gray-900 p-8 h-screen fixed top-0 left-0 flex flex-col justify-between transition-transform duration-300 ${isOpen ? 'display' : 'hidden'} md:display`}
      >
