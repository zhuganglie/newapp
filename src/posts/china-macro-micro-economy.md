...
> **摘要**：中国经济呈现一组引人注目的悖论：GDP维持约5%增长，但消费者信心跌至历史低位，青年失业率超17%，CPI趋近于零。为什么宏观总量的扩张未能传导为微观福利的改善？本文论证：在威权绩效合法性体制下[^1]，政策体系系统性地偏向"保数字"而非"保体感"。这一偏向源于三个结构性条件——GDP数字是绩效合法性的核心载体、多重制度机制将政策体系锁定在投资端、分散化的微观不满短期内难以聚合为政治挑战。本文推导三个可检验假说，以多维度描述性证据评估其经验一致性，并揭示该策略内含的自我击败逻辑。
>
...
> **在威权绩效合法性体制下，决策层面临"保总量数字"与"保分配体感"之间的结构性张力。由于总量数字是绩效合法性的核心载体，多重制度机制——财政体制的路径依赖、官僚组织能力的锁定、避责逻辑以及国家安全驱动的投资动员——共同将政策体系锁定在投资端，而分散化的微观不满短期内难以聚合为政治挑战，政策体系因此系统性地偏向"保数字"。然而，这一策略内含自我击败的逻辑：体感的持续恶化终将通过消费萎缩、人口下降和信号贬值等渠道，反噬数字本身。**
...
**中国增长模式文献**。Pettis（2013）分析了投资驱动型增长的内在失衡，周黎安（2007）揭示了"晋升锦标赛"如何在1990-2012年间系统性地激励投资扩张。然而，多项研究表明十八大以后晋升锦标赛的经典形态已显著弱化：政治忠诚对晋升的预测力上升，GDP绩效的边际效应下降（Shih, 2022; Landry, Lu & Duan, 2018），官僚行为从"晋升竞赛"向"避责竞赛"演变（周雪光，2022）。与此同时，"新型举国体制"（2019年正式采用）开辟了一条全新的、以国家安全和大国竞争为逻辑的自上而下投资动员路径（Naughton, 2021）。本文将上述文献整合为一个核心观察：**投资偏好在晋升锦标赛弱化后仍然持续，说明"保数字"偏向已从激励驱动演化为多重制度路径依赖**。
...
**"可操控性"与信号可信度**。数字的可操控性引出一个重要的理论张力：如果GDP数字可被系统性调控，其作为绩效信号的可信度理应逐步下降（Spence, 1973）。然而这一张力恰恰揭示了"保数字"策略短期有效与长期自我击败的内在逻辑。短期内，GDP数字仍然有效，因为国际机构的背书、替代信号的缺失以及统计偏差的模糊性共同支撑了其可信度。然而长期来看，维护成本上升、口径调整频繁化将使数字信号经历"信号通胀"（signal inflation），最终侵蚀绩效合法性的信息基础（详见§6.2）。

### 2.3 因果机制与假说推导

核心命题包含三个层次的因果主张，由此推导三个可检验假说。

**"保数字"偏向的主体性问题**。本文所论证的"偏向"兼具有意识的战略选择与制度路径依赖的无意识系统效应两重面向。两种机制并非互斥，而是各有侧重：有意识选择在绩效合法性的逻辑层面（假说一）更具解释力，制度惯性在政策工具选择层面（假说二）更具解释力，而纠偏压力的缺失（假说三）则使两种机制均得以持续。这一区分具有政策含义：若偏向主要来自有意识策略，则纠偏依赖政治意志的转变；若主要来自制度惯性，则纠偏需要制度结构的重塑。
...
**因果主张二**：多重制度机制的路径依赖强化了"保数字"偏好。

"保数字"的制度锁定并非来自单一机制，而是多重制度层叠（institutional layering）的结果。（a）**晋升锦标赛的历史遗产**：周黎安（2007）描述的晋升锦标赛在1990-2012年间奠定了投资驱动增长的制度基础。尽管十八大以后GDP绩效对晋升的预测力下降、考核体系多维化（Shih, 2022），但该时期形成的财政结构、官僚能力和组织惯性已深度嵌入地方治理。（b）**财政体制的路径依赖**：1994年分税制改革将收入向上集中但支出责任留给地方。地方承担约90%社会服务支出却仅获约50%税收，这一结构性缺口——而非晋升激励——才是地方依赖土地出让、LGFV融资和投资驱动的根本原因。（c）**官僚组织能力锁定**：三十年的投资驱动增长使地方官僚形成高度专业化的"搞项目"能力（招商引资、开发区管理、基建审批），但缺乏直接提供居民福利服务的组织能力（精准收入调查、社会工作网络、转移支付监督）。（d）**避责逻辑**：在高压反腐环境下，官僚行为从"晋升竞赛"向"避责竞赛"演变（周雪光，2022）。投资是"最安全"的政策选择——可见性强、可量化、责任可分散；而直接转移支付涉及精准识别和防腐能力，出错风险高。（e）**"新型举国体制"的自上而下投资动员**：这是习近平时代新增的、与晋升锦标赛逻辑完全不同的投资偏好来源。"新型举国体制"（2019年正式采用，Naughton, 2021）将国家资源集中投入半导体、AI、新能源等战略领域，以国家安全和大国技术竞争为驱动，形成中央主导的投资扩张——不依赖于地方官员的自下而上竞赛，却同样服务于"保数字"。这意味着：

> **假说二（制度锁定假说）**：即使在体感显著恶化的时期，财政支出结构和政策工具选择仍将保持对投资端的偏向，体现为"保数字"政策力度大、速度快，"保体感"政策力度小、效果弱。这一偏向的制度根源已从单一的晋升激励演化为多重路径依赖的叠加。
>
> *核心观测指标（不与假说一/三重叠）*：财政支出中基建/产业补贴 vs 民生（教育/医疗/社保）的比例、刺激方案构成（投资端 vs 转移支付）、政策工具出台速度差异、国家级产业基金规模与方向。
>
> *与假说一的判别*：假说二的独立贡献在于解释政策偏向的**制度成因**（财政体制路径依赖、官僚能力锁定、避责逻辑、举国体制投资动员），而非仅描述偏向的存在。若分配偏向存在但可完全由发展阶段或经济效率逻辑解释，则假说一成立但假说二不必然成立。**关键判别**：若晋升锦标赛已弱化但投资偏向仍持续，则多重制度锁定解释优于单一激励解释——这正是2012年以来的经验观察。
...
**"体感"为何未被主动政治化？** 一个值得分析的现象是：当前体制并未主动将分散化的微观不满政治化，以获取信息或强化合法性。历史上，中国共产党曾熟练运用"诉苦"等政治技术，将个体痛苦转化为集体叙事和政治动员资源（参见Polletta, 2006, *It Was Like a Fever*；裴宜理对"情感政治"的分析）。然而，在当前市场化社会中，主动开启"体感政治化"对执政者是高风险策略：（1）市场化改革使个体更倾向于自我归因，这种归因模式客观上有利于短期稳定；（2）一旦政治化微观不满，归因对象可能上移到政策制定层级，显著提高治理不确定性；（3）现有信息治理架构以抑制集体叙事扩散为目标，主动逆转该逻辑会产生较高官僚摩擦。因此，"体感"的非政治化状态应理解为一个收益-风险比偏低的治理选择，而非单纯的信息缺失。
...
flowchart TD
    subgraph 理论框架
        ...
        subgraph 多重制度锁定
            B1["晋升锦标赛遗产<br/>周黎安 2007"] --> E["制度性保数字偏好"]
            B2["分税制路径依赖<br/>1994年"] --> E
            B3["新型举国体制<br/>Naughton 2021"] --> E
            B4["避责逻辑<br/>周雪光 2022"] --> E
        end
...
假说二预测：即使体感显著恶化，政策工具选择仍保持对投资端的偏向。如果这一假说成立，我们应当观察到：（a）刺激经济的政策工具以投资和产业补贴为主，而非直接转移支付；（b）财政体制使地方政府承担体感责任但缺乏相应收入；（c）新兴产业政策服务于GDP数字而非就业吸纳；（d）即使晋升锦标赛弱化，"新型举国体制"下的中央主导投资动员仍持续强化投资偏好。
...
- 统计口径在2024年修改（排除在校生）。排除在校生具有合理的技术依据（ILO标准失业率定义关注"可立即就业"人口），国家统计局亦以提高国际可比性作为正式理由。然而，该调整恰在青年失业率创历史新高之后出台，且使公布数值显著下降，其时机与效果与"保数字"策略高度一致。无论决策者的主观意图如何，这一调整在客观功能上属于"保数字"行为

**证据4.2.3a："新型举国体制"——习时代新增的投资偏好来源**

习近平时代的投资偏好已不仅是地方官僚自下而上竞赛的产物，更叠加了中央自上而下的主动动员——"新型举国体制"（2019年正式采用）。这一机制以国家安全和大国技术竞争为驱动，与周黎安模型描述的晋升激励逻辑完全不同，却同样——甚至更强有力地——服务于"保数字"：

| 维度 | 晋升锦标赛时期（1990-2012） | 新型举国体制时期（2019至今） |
|------|---|---|
| 投资驱动主体 | 地方政府（自下而上） | 中央政府+央企（自上而下） |
| 驱动逻辑 | 晋升激励（GDP→升官） | 国家安全+大国竞争（技术自主→体制安全） |
| 投资领域 | 基建、房地产、开发区 | 半导体、AI、新能源、量子技术 |
| 典型规模 | 地方融资平台（LGFV） | 大基金三期3440亿元、国家创投引导基金1万亿元、央企研发年投入超1.1万亿元 |
| 对"体感"的影响 | 间接（创造建筑业就业） | 更弱（资本/技术密集型，就业吸纳有限） |

这一转变的理论含义是：**即使彻底废除GDP考核，中央主导的举国体制投资动员仍将维持"保数字"偏向**——因为其驱动逻辑已从经济绩效转移到国家安全。这使得假说二所描述的制度锁定更加深层、更难逆转。
...
描述性证据与假说二的预期方向一致。在体感承压的2024–2025年，政策工具仍偏向投资端，财政体制中“支出责任在地方、财源约束加剧”的结构性矛盾突出。本节的独有贡献在于揭示政策偏向的**多重制度成因**——晋升锦标赛的历史遗产、分税制的财政路径依赖、官僚组织能力锁定、避责逻辑、以及“新型举国体制”的自上而下投资动员，共同形成层叠式路径依赖，使“保数字”偏向具有系统性而非偶发性。这有别于假说一仅描述分配结果的偏向。一个关键的经验观察支持多重锁定而非单一激励解释：**即使晋升锦标赛在十八大后显著弱化，投资偏向仍然持续甚至强化**——这说明驱动力已从地方官员的自利激励转移到了财政结构约束和中央主导的安全驱动投资动员。当然，投资偏好也可能部分反映短期经济合理性（如乘数效应），这一替代解释有待省级财政面板分析进一步甄别。
...
[^4]: Hirschman原义中的"忠诚"（loyalty）指对组织的情感依附，促使个体选择"呼吁"而非"退出"。"内卷"不宜简单归入"忠诚"范畴，更准确地应理解为**"受限退出"（constrained exit）**——退出渠道受限时的被迫留守与过度竞争，而非出于情感依附的忠诚。
...
- 2024年修改青年失业率统计口径（排除在校生）——该调整在技术上具有ILO标准依据（详见§4.2.3），但其客观功能效果与"保数字"策略的方向一致

### 5.3 小结

描述性证据与假说三的预期方向相符。微观体感压力更多以“退出”而非组织化“呼吁”表达——这一不满表达方式的结构性偏向是假说三的独有预测，直接指向“纠偏压力为何缺失”的政治动力学问题。官方叙事的“数字锚定”则与假说一、二均有关联，属于共享的经验背景。应当指出，假说三的证据主要来自代理变量和文本观察，推断力度弱于假说一和二。假说三指向的是需求侧的政治动力学——不满本身的结构性无力，与决策层的主观意图无关，这意味着即使决策层有纠偏意愿，压力缺失机制也使其缺乏充分的信息反馈和执行动力。
...
- **韩国**（1990s末-2000s，民主政体，正面案例）：1997年金融危机后，韩国经历痛苦的结构调整，随后成功实现从投资驱动向消费与创新驱动的转型，家庭消费占GDP比重从约48%回升至50-51%（OECD.Stat, SNA Table 1）。其关键条件——**外部压力（IMF条件性贷款）、民主问责制、财阀改革释放的竞争活力**——在当前中国语境下均不具备，从反面支持了本文关于路径依赖和制度锁定的论证。**替代解释**：韩国转型是否主要由IMF外部约束而非国内民主问责驱动？如果外部冲击是主因，则中国在面临类似外部约束时也可能转型，制度锁定假说的适用范围需相应收窄。
...
> **比较设计的局限与适用边界**。上述案例比较为说明性（illustrative）而非方法论意义上的严格比较分析。三个案例各自面临不同的国际环境、经济体量和历史阶段，无法完全排除制度以外的变量（如外部冲击、全球化程度、人口规模）。
>
> **威权体制内部的异质性**。新加坡和越南作为威权（或半威权）体制，其消费占比表现为本文政体解释提供了重要的检验案例。新加坡家庭消费占GDP比重约36-38%（World Bank, WDI, 2022-2023年），**低于中国（39.9%）**，与本文逻辑方向一致，但也可能由其小型开放经济体的结构特征（高储蓄率、高出口依赖、强制性公积金制度）所驱动，与中国的因果机制并不相同。越南家庭消费占GDP比重约67-70%（World Bank, WDI, 2022年），**显著高于中国**——同为威权体制，越南的消费占比并不异常偏低，构成对简单政体解释的潜在反例。
>
> 对此需要指出两点：（1）越南的高消费占比可能反映其较低发展阶段——在人均GDP较低时，家庭消费通常占GDP较高比重，这是发展阶段效应而非政体效应；（2）更根本的是，本文的核心解释变量不是"威权体制"本身，而是**以GDP数字为绩效合法性核心载体**的特定威权治理模式。新加坡和越南的合法性基础与政策激励结构与中国存在重要差异（新加坡有更强的法治约束和国际竞争压力，越南的发展阶段使投资驱动增长的路径依赖尚未充分形成）。
>
> 因此，本文命题的适用范围应界定为：**处于特定发展阶段（中等收入及以上）、以GDP增速作为绩效合法性主要载体、且具有较强行政动员能力的威权体制**。对所有威权体制的一般化推论超出了本文的识别边界。未来研究可通过跨国面板（V-Dem政体指数×WDI消费占比×人均GDP分层）系统检验这一边界条件。
...
2. **制度锁定假说得到方向性支持**：晋升锦标赛的历史遗产、分税制财政路径依赖、官僚能力锁定、避责逻辑和“新型举国体制”的自上而下投资动员共同构成多重层叠的制度惯性。关键经验观察——晋升锦标赛弱化后投资偏向仍持续——支持多重锁定而非单一激励解释。
...
30. Shih, Victor (2022). *Coalitions of the Weak: Elite Politics in China from Mao's Stratagem to the Rise of Xi*. Cambridge University Press.
31. Landry, Pierre F., Lü Xiaobo & Duan Haiyan (2018). "Does Performance Matter? Evaluating Political Selection Along the Chinese Administrative Ladder." *Comparative Political Studies*, 51(8), 1074-1105.
32. 周雪光 (Zhou, Xueguang) (2022). 《中国国家治理的制度逻辑》. 三联书店.
33. Naughton, Barry (2021). *The Rise of China's Industrial Policy, 1978 to 2020*. Universidad Nacional Autónoma de México.

---

*本文基于截至2026年1月公开发布的数据与学术文献，部分结论为机制性推断（已标注识别边界）。部分数据存在准确性争议，已在正文中讨论。最后修订日期：2026年2月18日。*
